...
public class Interpret extends Data {
    ...
    public static final String[] PROCIND = {
            "WEAK", "STOP", "SLOW", "KB", "WARP", "CURSE", "IMUATK", "STRONG", "LETHAL", "ATKBASE", "CRIT", "METALKILL", "BREAK", "SHIELDBREAK",
    ...
    public static final int[] P_INDEX = {
            P_WEAK, P_STOP, P_SLOW, P_KB, P_WARP, P_CURSE, P_IMUATK, P_STRONG, P_LETHAL, P_ATKBASE, P_CRIT, P_METALKILL, P_BREAK,
