...
public class EnemyCommandConfigHolder extends ComponentHolder {
    ...
    public EnemyCommandConfigHolder(@Nullable Message author, long userID, long channelID, @Nonnull Message message, ConfigHolder config, ConfigHolder backup, CommonStatic.Lang.Locale lang) {
