...
public class ConfigBoosterChannelHolder extends ServerConfigHolder {
    ...
    public ConfigBoosterChannelHolder(@NotNull Message author, @NotNull String channelID, @NotNull Message message, @NotNull IDHolder holder, @NotNull IDHolder backup, CommonStatic.Lang.Locale lang) {
