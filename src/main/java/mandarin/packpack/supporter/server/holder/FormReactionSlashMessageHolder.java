...
public class FormReactionSlashMessageHolder extends MessageHolder {
    ...
    public FormReactionSlashMessageHolder(Message m, Form f, String memberID, String channelID, ConfigHolder config, boolean isFrame, boolean talent, boolean extra, Level lv, int lang) {
