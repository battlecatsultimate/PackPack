...
public class EnemyDPSButtonHolder extends ComponentHolder {
    ...
    public EnemyDPSButtonHolder(@Nullable Message author, long userID, long channelID, @Nonnull Message message, Enemy e, TreasureHolder t, EnemyStat.EnemyStatConfig configData, CommonStatic.Lang.Locale lang) {
