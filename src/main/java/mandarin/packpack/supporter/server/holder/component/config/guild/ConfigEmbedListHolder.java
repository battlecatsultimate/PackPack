...
public class ConfigEmbedListHolder extends ServerConfigHolder {
    ...
    public ConfigEmbedListHolder(@Nullable Message author, long userID, long channelID, @Nonnull Message message, @Nonnull IDHolder holder, @Nonnull IDHolder backup, CommonStatic.Lang.Locale lang) {
