...
public class ConfigUserBanHolder extends ServerConfigHolder {
    ...
    public ConfigUserBanHolder(@NotNull Message author, @NotNull String channelID, @NotNull Message message, @NotNull IDHolder holder, @NotNull IDHolder backup, int lang) {
