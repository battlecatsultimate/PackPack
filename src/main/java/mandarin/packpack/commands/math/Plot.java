...
public class Plot extends TimedConstraintCommand {
    ...
    public Plot(ConstraintCommand.ROLE role, CommonStatic.Lang.Locale lang, @Nullable IDHolder idHolder, long time) {
        super(role, lang, idHolder, time, StaticStore.COMMAND_PLOT_ID, false);
    }
    ...
    public void doSomething(@Nonnull CommandLoader loader) throws Exception {
        ...
        if(formula.variable.size() == 1) {
            ...
            if(plots == null) {
                ...
                components.add(TextDisplay.of("## " + LangID.getStringByID("plot.result", lang)));
                ...
                replyToMessageSafely(ch, loader.getMessage(), _ -> StaticStore.deleteFile((File) plots[0], true), e -> {
                    StaticStore.logger.uploadErrorLog(e, "E/Plot::doSomething - Failed to send plot image file");
