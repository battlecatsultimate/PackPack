...
public class Help extends Command {
    ...
    public void createEmbedOfSpecificCommand(String command, MessageChannel ch) {
        switch (command) {
            ...
            case "commandban":
            case "cb":
                ch.sendMessageEmbeds(addFields("commandban", false, false, false)).queue();
                break;
            case "commandunban":
            case "cub":
                ch.sendMessageEmbeds(addFields("commandunban", false, false, false)).queue();
                break;
            case "talentinfo":
            case "ti":
                ch.sendMessageEmbeds(addFields("talentinfo", true, false, false)).queue();
                break;
            case "soul":
            case "sl":
                ch.sendMessageEmbeds(addFields("soul", true, true, false)).queue();
                break;
            case "soulimage":
            case "soulimg":
            case "simage":
            case "simg":
                ch.sendMessageEmbeds(addFields("soulimage", true, true, false)).queue();
                break;
            case "soulsprite":
            case "ssprite":
            case "soulsp":
            case "ssp":
                ch.sendMessageEmbeds(addFields("soulsprite", false, false, false)).queue();
                break;
            case "calculator":
            case "calc":
            case "c":
            ...
            case "earchive":
            case "eda":
                ch.sendMessageEmbeds(addFields("eventdataarchive", true, true, false)).queue();
                break;
            default:
