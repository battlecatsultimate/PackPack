...
public class AliasRemove extends ConstraintCommand {
    ...
    public AliasRemove(ROLE role, CommonStatic.Lang.Locale lang, ConfigHolder config, IDHolder id) {
        ...
        switch (type) {
            case FORM -> {
                ...
                if (forms.isEmpty()) {
                    ...
                    if (!alias.contains(aliasName)) {
                        replyToMessageSafely(ch, loader.getMessage(), LangID.getStringByID("alias.failed.removeFail", lang));
                    ...
                    replyToMessageSafely(ch, loader.getMessage(), LangID.getStringByID("alias.removed", lang).formatted(fname, aliasName));
            ...
            case ENEMY -> {
                ...
                if (enemies.isEmpty()) {
                    ...
                    if (!alias.contains(aliasName)) {
                        replyToMessageSafely(ch, loader.getMessage(), LangID.getStringByID("alias.failed.removeFail", lang).formatted(eName));
                    ...
                    replyToMessageSafely(ch, loader.getMessage(), LangID.getStringByID("alias.removed", lang).formatted(eName, aliasName));
            ...
            case STAGE -> {
                ...
                if (stages.isEmpty()) {
                    ...
                    if (!alias.contains(aliasName)) {
                        replyToMessageSafely(ch, loader.getMessage(), LangID.getStringByID("alias.failed.removeFail", lang).formatted(stName));
                    ...
                    replyToMessageSafely(ch, loader.getMessage(), LangID.getStringByID("alias.removed", lang).formatted(stName, aliasName));
