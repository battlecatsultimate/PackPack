                ...
                if(stages.isEmpty()) {
                    ...
                    if(res != null) {
                        ...
                        getMember(event).ifPresent(member -> {
                            ...
                            if(msg != null)
                                StaticStore.putHolder(member.getId().asString(), new AliasStageMessageHolder(fStage, msg, res, ch.getId().asString(), AliasHolder.MODE.REMOVE, lang, getAliasName(getContent(event))));
                        });
                    }
                }
                break;
