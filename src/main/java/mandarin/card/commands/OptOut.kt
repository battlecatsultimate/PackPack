...
class OptOut : Command(CommonStatic.Lang.Locale.EN, false) {
    override fun doSomething(loader: CommandLoader) {
        replyToMessageSafely(loader.channel,
            ...
            StaticStore.putHolder(loader.user.idLong, ConfirmButtonHolder(loader.message, loader.user.idLong, loader.channel.idLong, msg, CommonStatic.Lang.Locale.EN) {
                replyToMessageSafely(loader.channel, "This is secondary confirmation message\n# Are you sure you want to opt out?", loader.message, { a -> registerConfirmButtons(a, CommonStatic.Lang.Locale.EN) }) { message ->
                    StaticStore.putHolder(loader.user.idLong, ConfirmButtonHolder(loader.message, loader.user.idLong, loader.channel.idLong, message, CommonStatic.Lang.Locale.EN) {
