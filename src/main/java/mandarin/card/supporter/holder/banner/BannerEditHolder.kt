...
class BannerEditHolder(author: Message, userID: Long, channelID: Long, message: Message, private val banner: Banner, private val createMode: Boolean) : ComponentHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    init {
