...
class ModifyCategoryHolder(author: Message, channelID: String, message: Message, private val inventory: Inventory, private val targetMember: Member) : ComponentHolder(author, channelID, message) {
    override fun clean() {
