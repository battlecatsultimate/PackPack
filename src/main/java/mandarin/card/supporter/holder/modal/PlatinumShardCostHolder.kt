...
class PlatinumShardCostHolder(author: Message, userID: Long, channelID: Long, message: Message, private val cost: PackCost) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
