...
class CraftCostModifyHolder(author: Message, userID: Long, channelID: Long, message: Message, private val mode: CardData.CraftMode, private val editor: Runnable) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
