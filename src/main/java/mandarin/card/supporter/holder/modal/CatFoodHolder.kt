...
class CatFoodHolder(author: Message, userID: Long, channelID: Long, message:Message, private val suggestMessage: Message, private val suggestion: Suggestion) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
