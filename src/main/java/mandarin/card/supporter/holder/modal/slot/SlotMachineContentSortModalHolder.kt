...
class SlotMachineContentSortModalHolder(author: Message, userID: Long, channelID: Long, message: Message, private val onSelect: (Int, ModalInteractionEvent) -> Unit) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
