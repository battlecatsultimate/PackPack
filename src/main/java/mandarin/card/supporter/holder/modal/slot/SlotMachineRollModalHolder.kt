...
class SlotMachineRollModalHolder(author: Message, userID: Long, channelID: Long, message: Message, private val slotMachine: SlotMachine, private val inventory: Inventory, private val onSelected: (ModalInteractionEvent, Long) -> Unit) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
