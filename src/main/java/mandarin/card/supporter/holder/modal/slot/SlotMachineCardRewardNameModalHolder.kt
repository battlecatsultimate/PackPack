...
class SlotMachineCardRewardNameModalHolder(author: Message, userID: Long, channelID: Long, message: Message, private val content: SlotCardContent) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
