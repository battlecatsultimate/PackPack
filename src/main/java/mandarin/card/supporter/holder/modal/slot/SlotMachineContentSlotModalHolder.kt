...
class SlotMachineContentSlotModalHolder(author: Message, userID: Long, channelID: Long, message: Message, private val slotMachine: SlotMachine, private val slotContent: SlotContent) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
