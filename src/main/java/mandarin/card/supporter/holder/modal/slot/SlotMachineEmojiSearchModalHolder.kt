...
class SlotMachineEmojiSearchModalHolder(author: Message, userID: Long, channelID: Long, message: Message, private val onSelect: (String) -> Unit) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
