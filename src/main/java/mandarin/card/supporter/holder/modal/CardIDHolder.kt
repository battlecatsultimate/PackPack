...
class CardIDHolder(author: Message, userID: Long, channelID: Long, message: Message, private val card: Card, private val createMode: Boolean) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
