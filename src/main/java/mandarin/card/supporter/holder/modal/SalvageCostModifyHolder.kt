...
class SalvageCostModifyHolder(author: Message, userID: Long, channelID: Long, message: Message, private val mode: CardData.SalvageMode, private val editor: Runnable) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
