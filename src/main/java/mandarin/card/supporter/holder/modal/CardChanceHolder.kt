...
class CardChanceHolder(author: Message, userID: Long, channelID: Long, message: Message, private val pack: CardPack, private val cardChancePair: CardChancePair) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
