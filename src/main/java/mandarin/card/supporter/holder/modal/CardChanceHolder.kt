...
class CardChanceHolder(author: Message, channelID: String, messageID: String, private val pack: CardPack, private val cardChancePair: CardChancePair) : ModalHolder(author, channelID, messageID) {
    override fun clean() {
