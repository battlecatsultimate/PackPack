...
class SlotManualRollInputHolder(author: Message, userID: Long, channelID: Long, message: Message, private val input: KMutableProperty0<Long>, private val slotMachine: SlotMachine) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
