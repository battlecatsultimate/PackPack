...
class CooldownRateHolder(author: Message, userID: Long, channelID: Long, message: Message, private val editor: Runnable) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
