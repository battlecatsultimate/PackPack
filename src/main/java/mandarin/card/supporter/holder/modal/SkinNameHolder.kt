...
class SkinNameHolder(author: Message, userID: Long, channelID: Long, message: Message, private val skin: Skin) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
