...
class CraftAmountHolder(author: Message, userID: Long, channelID: Long, message: Message, private val editor: (Int) -> Unit) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
