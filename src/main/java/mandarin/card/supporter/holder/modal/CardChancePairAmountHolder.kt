...
class CardChancePairAmountHolder(author: Message, userID: Long, channelID: Long, message: Message, private val cardChancePairList: CardChancePairList) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
