...
class CardChancePairAmountHolder(author: Message, channelID: String, message: Message, private val cardChancePairList: CardChancePairList) : ModalHolder(author, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
