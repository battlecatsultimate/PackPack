...
class CardCostAmountHolder(author: Message, userID: Long, channelID: Long, message: Message, private val cost: CardCost) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
