...
class AuctionInitialPriceHolder(author: Message, userID: Long, channelID: Long, message: Message, private val onSelected: (Long) -> Unit) : ModalHolder(author, userID, channelID, message, CommonStatic.Lang.Locale.EN) {
    override fun clean() {
