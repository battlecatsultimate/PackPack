...
class SkinCostTypeHolder(author: Message, channelID: String, private val message: Message, private val skin: Skin) : ComponentHolder(author, channelID, message.id) {
    override fun clean() {
