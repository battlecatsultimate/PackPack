...
class SkinCostManageHolder(author: Message, channelID: String, message: Message, private val skin: Skin) : ComponentHolder(author, channelID, message), MessageUpdater {
    override fun clean() {
